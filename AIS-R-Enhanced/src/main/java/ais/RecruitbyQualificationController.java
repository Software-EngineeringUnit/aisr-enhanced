...
// Controller class for displaying recruits based on qualification.
public class RecruitbyQualificationController {
    ...
    private void loadDataFromDatabase() {
        ...
        String query = "SELECT * FROM recruits WHERE QualificationLevel = ?";
        ...
        try ( Connection conn = DriverManager.getConnection(App.DB_URL + App.DB_NAME, App.DB_USER, App.DB_PASSWORD);  PreparedStatement pstmt = conn.prepareStatement(query)) {
            ...
            pstmt.setString(1, ManagementDashboardController.qualification); // Set the qualification parameter
